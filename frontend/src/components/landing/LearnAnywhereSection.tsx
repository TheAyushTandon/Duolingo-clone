  ...
  return (
    <div className="relative w-full overflow-x-clip max-w-[100vw]">
      ...
      */}
      ...
      {/* Natural Scrolling Interactive Section (not stuck) on Duolingo Sky Blue (#E0F5FF) */}
      <section
        ref={containerRef}
        className="relative w-full bg-[#E0F5FF] select-none pt-4 sm:pt-6 pb-48 sm:pb-64 lg:pb-80 px-4 sm:px-8 overflow-x-clip max-w-[100vw] flex flex-col items-center"
      >
        {/* Top Header & Store Download Badges */}
        <div className="z-20 flex flex-col items-center text-center space-y-5 max-w-2xl mx-auto">
          {/* Headline in Duolingo Feather Bold & Deep Navy #042C60 */}
          <h2
            className="learn-anywhere-title font-feather text-4xl sm:text-6xl lg:text-[64px] font-black lowercase leading-[1.08] tracking-tight !text-[#042C60]"
            style={{ color: "#042C60" }}
          >
            <span className="learn-anywhere-title !text-[#042C60]" style={{ color: "#042C60" }}>
              learn anytime,
            </span>
            <br />
            <span className="learn-anywhere-title !text-[#042C60]" style={{ color: "#042C60" }}>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3.5 pt-1">
            ...
            <a
              className="sknt2 bg-white border-2 border-[#E5E5E5] hover:border-[#1CB0F6] active:translate-y-0.5 shadow-[0_2px_0_#E5E5E5] transition-all rounded-2xl px-4 sm:px-5 py-2.5 flex items-center gap-3 cursor-pointer group !text-[#042C60]"
              href="//itunes.apple.com/app/duolingo-learn-spanish-french/id570060128?mt=8"
              target="_blank"
              rel="noopener noreferrer"
              style={{ color: "#042C60" }}
            >
              <span className="flex items-center justify-center shrink-0 !text-[#042C60]" style={{ color: "#042C60" }}>
                <svg viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 sm:w-8 sm:h-8 !text-[#042C60] group-hover:scale-105 transition-transform" style={{ color: "#042C60" }}>
              ...
              <span className="flex flex-col items-start leading-tight text-left">
                <span className="text-[10.5px] font-bold !text-[#042C60] tracking-tight block leading-none" style={{ color: "#042C60" }}>
                  Download on the
                </span>
                <span className="text-[15px] font-black !text-[#042C60] tracking-tight block leading-none mt-1" style={{ color: "#042C60" }}>
                  App Store
                </span>
              </span>
            </a>
        ...
        {/* Central Isometric Floating Illustration - Exact original prominent size, clipped horizontally */}
        <div className="w-full max-w-[100vw] flex items-center justify-center relative mt-8 sm:mt-12 scale-[1.12] sm:scale-[1.2] lg:scale-[1.28] xl:scale-[1.34] origin-center pointer-events-none">
          <DuolingoLearnAnywhereAnimation progress={animProgress} />
        </div>
      </section>

      {/* 
        Dedicated Generous Spacing Buffer between Learn Anywhere SVGs and Super Duolingo section.
        Ensures the floating isometric phones and characters have vast breathing room at bottom.
      */}
      <div
        className="w-full h-[25vh] sm:h-[35vh] min-h-[240px] bg-[#E0F5FF] pointer-events-none relative z-10"
        aria-hidden="true"
      />
    </div>
  );
